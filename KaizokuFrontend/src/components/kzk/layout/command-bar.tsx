...
import { SectionList, SectionPills } from "@/components/kzk/layout/section-pills";
import { UserAvatarDropdown } from "@/components/kzk/layout/user-menu";
...
import { useRibbonMount } from "@/components/kzk/layout/ribbon";
        ...
        <Sheet open={sheetOpen} onOpenChange={setSheetOpen}>
          ...
          >
            <div className="flex items-center gap-2 px-4 py-3 border-b">
              ...
              />
              <span className="text-sm font-semibold">Kaizoku.NET</span>
            </div>
